...
class Basket {
    ...
    add(item: Fruit, quantity: number): void {
    ...
    getItems(): ReadonlyArray<BasketItem> {
        return this.items;
    }
...
const apple: Fruit = { name: "apple", color: "red", price: 10 };
const orange: Fruit = { name: "orange", color: "orange", price: 20 };
